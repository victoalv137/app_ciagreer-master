...
<div class="row">
    <div class="col-md-6">
        ...
        <input type="text" class="form-control" value="{{$bomba->codigo}}" placeholder="Ingresar Codigo" name="codigo">
    </div>
    <div class="col-md-6">       
        <label for="">Costo</label>       
        <div class="input-group">                
        <span class="input-group-text">$</span>
        <input type="text" class="form-control" value="{{$bomba->costo}}" placeholder="Ingresar Costo Producto" name="costo">      
        </div>
    </div>
</div><br>
<div class="row">
...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="input-group">              
            <input type="text" class="form-control" value="{{$bomba->alto}}" placeholder="Ingresar Caballos  de Fuerza" name="alto">
            <span class="input-group-text">mm</span>      
        </div><br>
        <label for="">Ancho</label>
        <div class="input-group">              
            <input type="text" class="form-control" value="{{$bomba->ancho}}"  placeholder="Ingresar Maxima Altitud Dinamica" name="ancho">
            <span class="input-group-text">mm</span>      
        </div>
    </div>
    <div class="col-md-6">
        ...
        <div class="input-group">              
            <input type="text" class="form-control" value="{{$bomba->caballo}}"  placeholder="Ingresar Caballos  de Fuerza" name="caballo">
            <span class="input-group-text">HP</span>      
        </div><br>
        <label for="">Velocidad</label>
        <div class="input-group">              
            <input type="text" class="form-control" value="{{$bomba->velocidad}}"  placeholder="Ingresar Maxima Altitud Dinamica" name="velocidad">
