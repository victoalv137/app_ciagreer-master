 ...
 <div class="row">
    ...
    <div class="row">
            ...
            <div class="col-md-6">       
                    ...
                    <input type="text" class="form-control" value="{{$alquiler->cotizacion->producto->costo}}" name="costo" disabled>
            </div>
    </div><br>
...
<div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="input-group">  
                ...
                <input type="text" class="form-control" value={{$alquiler->tiempo}} placeholder="Ingresar Tiempo Alquiler" name="tiempo">
            </div>
        </div>
    </div>
</form>
