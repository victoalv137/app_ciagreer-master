                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <p>Marca {{$ventilador->marca}}, Modelo {{$ventilador->modelo}}, de 15 HP</p>
                    ...
                    <tr>
                        <td>
                            ...
                            <p>Capacidad: {{$ventilador->capacidad}} CFM</p>
                            <p>Medida Salida: {{$ventilador->medida}} pulg</p>                        
                       </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td colspan="3"></td>
                        <td>TOTAL</td>
                        <td>$ {{$ventilador->producto->costo}} (incluye precio tablero)</td>
                    </tr>
                </tbody>
            </table>
